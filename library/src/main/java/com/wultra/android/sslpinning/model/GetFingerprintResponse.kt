...
data class GetFingerprintResponse @JvmOverloads constructor(
     ...
     * @property signature Legacy per-entry ECDSA signature field that may be present in the JSON response.
     *                     This optional field is kept for backwards-compatible JSON parsing;
     *                     current signature validation uses the response header signature in challenge mode.
